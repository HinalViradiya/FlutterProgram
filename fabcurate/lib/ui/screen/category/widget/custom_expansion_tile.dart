...
class CustomExpansionTile extends StatefulWidget {
  ...
  })  : assert(initiallyExpanded != true),
        assert(maintainState != true),
        assert(
...
class _CustomExpansionTileState extends State<CustomExpansionTile>
            ...
            child: ListTile(
              ...
              trailing: Padding(
                padding: EdgeInsets.only(
                    top: MediaQuery.of(context).size.height * .04, right: 30),
  ...
  void didChangeDependencies() {
    ...
    _borderColorTween.end = widget.backgroundColor ?? widget.background1;
    _headerColorTween
    ...
    _backgroundColorTween
      ...
      ..end = widget.backgroundColor ?? widget.background1;
